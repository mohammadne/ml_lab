import asyncio  # run function in async manner
...
async def main():
    async with agent:
        ...
        # result = await agent.run("What is the current stock price of Tesla?")  # this won't be answered with the weather tool
    print(result)
